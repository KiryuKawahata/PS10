...
train_score <- sqrt(sum(PS10_Lm$residuals)^2)/nrow(train)
...
train_price_doc <- predict(LASSO_fit, newx = predictor_matrix_train, s = lambda_star_1SE) 

train_score <- sqrt(sum(train$log_price_doc- train_price_doc)^2)/nrow(train)
...
--------------------- | -------------   | -------------
lm                    |    1.474e-17    |  2.63413
LASSO crossvalidated  |    3.351e-15    |  0.42805
